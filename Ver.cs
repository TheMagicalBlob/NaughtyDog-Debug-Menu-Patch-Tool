...
namespace Dobby {
    public static class Ver {
       ...
       "* 2.11-beta.22.48 | EbootPatchInformationPage Added Info, Font Change For Readability",
            ...
            "* 2.17.32.75 | Moving Debug Restoration Code To separate Functions Outside Of Switch Case Because Reasons, Other Misc. Changes",
        ...
        "* 2.18-tmp.36.78 | Added Rendering Menu Patch For T1R 1.00, Misc.",
            ...
            "* 2.19.42.92 | Fixed Main Page separator Lines",
           ...
           "* 2.19.55.123 | Replaced Border Background Images On Dobby And EbootPatchPage With A Group Box, For Obvious Reasons, Repositioned The ManualConnectButton, It Was Too Close To The separator Line Below",
       ...
       "* 2.21-tmp.58.131 | Added Buttons For Still Uncreated PC-Specific Pages, Credits page text and spacing changes",
           "* 2.21.61.140 | Split main form in to separate PS4 and PC sections, added two pages for the new pc section. Changed contact details line on the InfoHelpPage. Merged Main.Designer.cs with Main.cs, Moved MainStream variable EbootPatchPage.cs -> Common.cs for use with PC Patch Pages",
           ...
           "* 2.21.67.170 | Added Most offsets, Replaced T1R 1.00 Debug Offset, Added All T2 JNZ Debug Offsets, separator Label Border Overlap Fix",
      ...
      "* 3-beta.25.76.177 | I have no idea anymore. new feature tho",
           ...
           "* 3.26.77.192 | Fixed A String In ExecutableNames Array that I for some reason stopped typing mid-way, EbootPatchPage GroupBox Adjust, Added Uncharted Pointers, separated Debug Offsets & Pointers A Bit More",
          ...
          "* 3.30.109.304 | PkgCreationPage Base Creation. Made The TextBox In EbootPatchPage Actually Functional, Moved GetGameID() And AssignButtonText() Part To separate Function Below. Stopped Path Boxes From Getting MoveForm Functionality So the User Can Drag-Select The Text, Comments, Other Crap",
          ...
          "* 3.39.165.451 | Reworked Several Functions, Moved Dev Class In TO separate File. Other Blah Blah Blah",
          ...
          "* 4.46.212.560 | PS4 Menu Settings Page Release, Code Restructuring For Most Pages. (Moved PS4DebugPage Related Variables From Common.cs In To PS4DebugPage.cs, Small Tweaks), Log Window Fixes (Properly Follows The Parent Form Now Instead Of Snapping To It). Standardized separator Label Heights And Adjusted Various Control Positions Application-Wide.",
          ...
          "* 4.47.224.603 | PkgCreationPage Work, Changed separator Line Positioning And Sizing Replaced Static Exit/Minimize Buttons With Dynamic Initialization During Form Init (Through AddEventHandlersToControls()), Other Misc Changes",
          ...
          "* 4.49.266.748 | Slight update to the DrawseparatorLine method. (Just realized the lines aren't centered >:(. ), Changed label flash method to be less clunky, as well as support the main info label (or any control with a Color property, really...)",
          ...
          "* 4.59.340.874 | Fixed improper SetInfoLabelText usage in event handlers managed on a separate thread.",
          ...
          "* 4.62.373.951 | Moved the DynamicPatchButtons class contents to the parent form (why was it even a separate class??). Other crap. (detailed, I know)",
          ...
          "* 4.68.456.1109 | Fixed improperly-named separator line (blind moron).",
