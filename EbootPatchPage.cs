    ...
    public class EbootPatchPage : Form {
        ...
        void T2109_CustomMenu() { // 1.08 as well, same offsets
            ...
            int[] Addresses = new int[] {
                0x2DF3B41, // CustomMenuRedirect (Mem: 0x31efb41)
                0x2DF3B52, // DMenuPtrFuncSH (Mem: 0x31efb52)
                0x2DF3b85, // AppendDMenuItem (Mem: 0x31efb85)
                0x2DF3bf2, // GetSub (Mem: 0x31efbf2)
                0x2DF3c20, // CreateMenuTestMenu (Mem: 0x31efc20)
                0x2DF3c65, // subCreate (Mem: 0x31efc65)
                0x2DF3d7d, // fCreate (Mem: 0x31efd7d)
                0x2DF3ee5, // iCreate (Mem: 0x31efee5)
                0x2DF400B, // CreateSeperatorLine (Mem: 0x31f000b)
                0x2DF40d5, // Prog Pause Func (Mem: 0x31f00d5)
                0x2DF4213, // CMenuMenu (Mem: 0x31f0213)
                0x2DF4356  // CCustomMenu (Mem: 0x31f0356)
            };

            #region Custom Function Data Assignments
            // CustomMenuRedirect
            // 0x2DF3b41
            CustomFunctions[0] = new byte[] { 0x48, 0x89, 0xff, 0xe8, 0x0d, 0x08, 0x00, 0x00, 0xe8, 0x12, 0xad, 0x7b, 0xff, 0x48, 0x89, 0xc0, 0xc3 };
            // DMenuPtrFuncSH
            // 0x2DF3b52
            CustomFunctions[1] = new byte[] { 0x53, 0x41, 0x50, 0x41, 0x52, 0x41, 0x53, 0x41, 0x54, 0x4c, 0x8d, 0x25, 0x2e, 0x68, 0xcb, 0xff, 0xbe, 0x10, 0x00, 0x00, 0x00, 0x89, 0xff, 0x31, 0xdb, 0x31, 0xc9, 0x4c, 0x89, 0xe2, 0x4d, 0x89, 0xe0, 0xe8, 0x38, 0x71, 0xd5, 0xfe, 0x48, 0x89, 0xc0, 0x41, 0x5c, 0x41, 0x5b, 0x41, 0x5a, 0x41, 0x58, 0x5b, 0xc3 };
            // AppendDMenuItem
            // 0x2DF3b85
            ...
            // GetSub
            // 0x2DF3bf2
            CustomFunctions[3] = new byte[] { 0x48, 0x8d, 0x3e, 0xe8, 0x06, 0xb8, 0x9c, 0xff, 0x48, 0x01, 0xc7, 0x80, 0x7f, 0x01, 0xff, 0x75, 0x05, 0x48, 0x8d, 0x47, 0x02, 0xc3, 0x48, 0x31, 0xc0, 0xc3 };
            // CreateMenuTestMenu
            // 0x2DF3c20
            CustomFunctions[4] = new byte[] { 0x41, 0x56, 0x41, 0x57, 0x49, 0x89, 0xff, 0xba, 0xe8, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x3e, 0x09, 0x00, 0x00, 0x48, 0x31, 0xff, 0x48, 0x31, 0xc9, 0xe8, 0x27, 0x00, 0x00, 0x00, 0x49, 0x89, 0xc6, 0x48, 0x89, 0xc7, 0xba, 0xc0, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0xed, 0x08, 0x00, 0x00, 0x49, 0x8b, 0xcf, 0xe8, 0x0d, 0x00, 0x00, 0x00, 0x49, 0x8b, 0xf6, 0xe8, 0xb0, 0x2e, 0xa5, 0xfe, 0x41, 0x5f, 0x41, 0x5e, 0xc3 };
            // subCreate
            // 0x2DF3c65
            ...
            // Prog Pause Func
            // 0x2DF40d5
            CustomFunctions[9] = new byte[] { 0x8a, 0x05, 0x5e, 0xa5, 0x46, 0x00, 0x83, 0xfe, 0x05, 0x75, 0x10, 0x34, 0x01, 0x88, 0x05, 0x51, 0xa5, 0x46, 0x00, 0x80, 0x35, 0x9a, 0xa5, 0x46, 0x00, 0x01, 0xc3, 0x83, 0xfe, 0x08, 0x74, 0xf3, 0xc3 };
            // CMenuMenu
            // 0x2DF4213
            CustomFunctions[10] = new byte[] { 0x41, 0x56, 0x41, 0x57, 0x49, 0x89, 0xff, 0xba, 0xe8, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x56, 0x03, 0x00, 0x00, 0x48, 0x31, 0xff, 0x48, 0x31, 0xc9, 0xe8, 0x34, 0xfa, 0xff, 0xff, 0x49, 0x89, 0xc6, 0x48, 0x89, 0xc7, 0xba, 0xc0, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x3e, 0x03, 0x00, 0x00, 0x49, 0x8b, 0xcf, 0xe8, 0x1a, 0xfa, 0xff, 0xff, 0xbb, 0xe8, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x32, 0x03, 0x00, 0x00, 0x48, 0x8d, 0x15, 0x77, 0xfe, 0xff, 0xff, 0x49, 0x8b, 0xfe, 0x48, 0x8d, 0x0d, 0xd1, 0xa3, 0x46, 0x00 };
            // CCustomMenu
            // 0x2DF4356
            CustomFunctions[11] = new byte[] { 0x41, 0x57, 0x41, 0x56, 0x41, 0x55, 0x41, 0x54, 0x49, 0x89, 0xff, 0xba, 0xe8, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x5b, 0x01, 0x00, 0x00, 0x48, 0x31, 0xff, 0x48, 0x31, 0xc9, 0xe8, 0xed, 0xf8, 0xff, 0xff, 0x49, 0x89, 0xc4, 0xba, 0xc0, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x55, 0x01, 0x00, 0x00, 0x48, 0x89, 0xc7, 0x49, 0x8b, 0xcf, 0xe8, 0xd3, 0xf8, 0xff, 0xff, 0xbb, 0xe8, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x35, 0x64, 0x01, 0x00, 0x00, 0x48, 0x8d, 0x0d, 0x87, 0x9a, 0x25, 0x00, 0x49, 0x8b, 0xfc, 0x48, 0x31, 0xd2 };

            #endregion


            // Write String Data
            WriteBytes(0x2DF44C8, new byte[] { 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x20, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x20, 0x4d, 0x65, 0x6e, 0x75, 0x00, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x2e, 0x2e, 0x2e, 0x00, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x20, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x00, 0xff, 0x54, 0x4d, 0x50, 0x20, 0x53, 0x74, 0x72, 0x00, 0x44, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x20, 0x41, 0x6c, 0x6c, 0x20, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x00, 0xff, 0x44, 0x69, 0x73 });
            // Write Float Item Params
            WriteBytes(0x2DF47DD, new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x3f, 0xcd, 0xcc, 0x4c, 0x3d, 0x00, 0x00, 0x80, 0x3e, 0x46, 0x0d, 0xa6, 0x3d, 0x00, 0x00, 0xc0, 0x3f, 0xcd, 0xcc, 0x4c, 0x3d, 0x9a, 0x99, 0x19, 0x3e, 0xa6, 0x9b, 0x44, 0x3c, 0x00, 0x00, 0xc8, 0x41, 0xcd, 0xcc, 0xcc, 0x3d, 0x00, 0x00, 0x80, 0x3e });
            ...
            // Skip "Render Pause" And "Reload Ingame Shaders" DMenu Items
