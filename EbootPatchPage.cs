    ...
    public class EbootPatchPage : Form {
        ...
        public string GetMenuPatchTypeAvailability() {
            switch(Game) {
                ...
                ////
                case T2109:
                    RestoredDebugBtn.Font = new Font("Franklin Gothic Medium", 9.25F);
                    RestoredDebugBtn.Enabled = true; return " Restored/Custom";
                case T1R110:
                case T1R111:
                case UC1100:
                case UC1102:
        ...
        void T2109_CustomMenu() { // 1.08 as well, same offsets
            ...
            // Enable Debug Mode
            //WriteByte(0x618255, 0x95);

            // Custom Functions
            byte[][] CustomFunctions = new byte[12][];
            int[] Addresses = new int[] {
                0x02df3b41, // CustomMenuRedirect (Mem: 031efb41)
                0x02df3b52, // DMenuPtrFuncSH (Mem: 031efb52)
                0x02df3b85, // AppendDMenuItem (Mem: 031efb85)
                0x02df3bf2, // GetSub (Mem: 031efbf2)
                0x02df3c20, // CreateMenuTestMenu (Mem: 031efc20)
                0x02df3c65, // subCreate (Mem: 031efc65)
                0x02df3d7d, // fCreate (Mem: 031efd7d)
                0x02df3ee5, // iCreate (Mem: 031efee5)
                0x02df400b, // CreateSeperatorLine (Mem: 031f000b)
                0x02df40d5, // ProgPauseFunc (Mem: 031f00d5)
                0x02df4213, // CMenuMenu (Mem: 031f0213)
                0x02df4356  // CCustomMenu (Mem: 031f0356)
            };


            #region Custom Function Data Assignments

            // CustomMenuRedirect
            // 0x2DF3b41
            CustomFunctions[0] = new byte[] { 0x48, 0x89, 0xFF, 0xE8, 0x0D, 0x08, 0x00, 0x00, 0xE8, 0x12, 0xAD, 0x7B, 0xFF, 0x48, 0x89, 0xC0, 0xC3 }; // 0x02df3b41 CustomMenuRedirect
            // DMenuPtrFuncSH
            // 0x2DF3b52
            CustomFunctions[1] = new byte[] { 0x53, 0x41, 0x50, 0x41, 0x52, 0x41, 0x53, 0x41, 0x54, 0x4C, 0x8D, 0x25, 0x2E, 0x68, 0xCB, 0xFF, 0xBE, 0x10, 0x00, 0x00, 0x00, 0x89, 0xFF, 0x31, 0xDB, 0x31, 0xC9, 0x4C, 0x89, 0xE2, 0x4D, 0x89, 0xE0, 0xE8, 0x38, 0x71, 0xD5, 0xFE, 0x48, 0x89, 0xC0, 0x41, 0x5C, 0x41, 0x5B, 0x41, 0x5A, 0x41, 0x58, 0x5B, 0xC3 }; // 0x02df3b52 DMenuPtrFuncSH
            // AppendDMenuItem
            // 0x2DF3b85
            CustomFunctions[2] = new byte[] { 0x41, 0x57, 0x41, 0x56, 0x53, 0x49, 0x89, 0xFF, 0x48, 0x89, 0xD3, 0x31, 0xC0, 0x4D, 0x8D, 0xB7, 0xB0, 0x00, 0x00, 0x00, 0x49, 0x8B, 0xD6, 0x48, 0x89, 0xC1, 0x48, 0x8B, 0x02, 0x48, 0x85, 0xC0, 0x48, 0x8D, 0x50, 0x40, 0x75, 0xF1, 0x48, 0x85, 0xC9, 0x48, 0x8D, 0x41, 0x40, 0x49, 0x0F, 0x44, 0xC6, 0x48, 0x89, 0x18, 0x48, 0xC7, 0x43, 0x40, 0x00, 0x00, 0x00, 0x00, 0x4C, 0x89, 0x7B, 0x38, 0x41, 0xFF, 0x87, 0xA0, 0x00, 0x00, 0x00, 0x41, 0xC6, 0x87, 0xA8, 0x00, 0x00, 0x00, 0x01, 0x5B, 0x41, 0x5E, 0x41, 0x5F, 0xC3 }; // 0x02df3b85 AppendDMenuItem
            // GetSub
            // 0x2DF3bf2
            CustomFunctions[3] = new byte[] { 0x48, 0x8D, 0x3E, 0xE8, 0x06, 0xB8, 0x9C, 0xFF, 0x48, 0x01, 0xC7, 0x80, 0x7F, 0x01, 0xFF, 0x75, 0x05, 0x48, 0x8D, 0x47, 0x02, 0xC3, 0x48, 0x31, 0xC0, 0xC3 }; // 0x02df3bf2 GetSub
            // CreateMenuTestMenu
            // 0x2DF3c20
            CustomFunctions[4] = new byte[] { 0x41, 0x56, 0x41, 0x57, 0x49, 0x89, 0xFF, 0xBA, 0xE8, 0x00, 0x00, 0x00, 0x48, 0x8D, 0x35, 0x3E, 0x09, 0x00, 0x00, 0x48, 0x31, 0xFF, 0x48, 0x31, 0xC9, 0xE8, 0x27, 0x00, 0x00, 0x00, 0x49, 0x89, 0xC6, 0x48, 0x89, 0xC7, 0xBA, 0xC0, 0x00, 0x00, 0x00, 0x48, 0x8D, 0x35, 0xED, 0x08, 0x00, 0x00, 0x49, 0x8B, 0xCF, 0xE8, 0x0D, 0x00, 0x00, 0x00, 0x49, 0x8B, 0xF6, 0xE8, 0xB0, 0x2E, 0xA5, 0xFE, 0x41, 0x5F, 0x41, 0x5E, 0xC3 }; // 0x02df3c20 CreateMenuTestMenu
            // subCreate
            // 0x2DF3c65
            CustomFunctions[5] = new byte[] {  }; // 0x02df3c65 subCreate
            // fCreate
            // 0x2DF3d7d
            CustomFunctions[6] = new byte[] {  }; // 0x02df3d7d fCreate
            // iCreate
            // 0x2DF3ee5
            CustomFunctions[7] = new byte[] {  }; // 0x02df3ee5 iCreate
            // CreateSeperatorLine
            // 0x2DF400b
            CustomFunctions[8] = new byte[] {  }; // 0x02df400b CreateSeperatorLine
            // Prog Pause Func
            // 0x2DF40d5
            CustomFunctions[9] = new byte[] { 0x8A, 0x05, 0x5E, 0xA5, 0x46, 0x00, 0x83, 0xFE, 0x05, 0x75, 0x10, 0x34, 0x01, 0x88, 0x05, 0x51, 0xA5, 0x46, 0x00, 0x80, 0x35, 0x9A, 0xA5, 0x46, 0x00, 0x01, 0xC3, 0x83, 0xFE, 0x08, 0x74, 0xF3, 0xC3 }; // 0x02df40d5 ProgPauseFunc
            // CMenuMenu
            // 0x2DF4213
            CustomFunctions[10] = new byte[] {  }; // 0x02df4213 CMenuMenu
            // CCustomMenu
            // 0x2DF4356
            CustomFunctions[11] = new byte[] {  }; // 0x02df4356 CCustomMenu
            #endregion
            ...
            // Call CustomMenuRedirect
            WriteBytes(0x774B3C, new byte[] { 0x48, 0x8D, 0x15, 0x4D, 0x58, 0x33, 0x02, 0x49, 0x8B, 0xFD, 0xE8, 0xF6, 0xEF, 0x67, 0x02, 0x49, 0x89, 0xC6, 0xBF, 0xC0, 0x00, 0x00, 0x00, 0xE8, 0xFA, 0xEF, 0x67, 0x02, 0xEB, 0x07 });
            // Call Menu... SubMenu
            WriteBytes(0x7782BC, new byte[] { 0x49, 0x8B, 0xFD, 0xE8, 0x4F, 0xBF, 0x67, 0x02, 0x49, 0x8B, 0xFD, 0xE8, 0x54, 0xB9, 0x67, 0x02, 0xEB, 0x70 });
            // Write String Data
            WriteBytes(0x2df44c7, new byte[] {  });
            // Write Float Item Params
            WriteBytes(0x2df47dc, new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x3F, 0xCD, 0xCC, 0x4C, 0x3D, 0x00, 0x00, 0x80, 0x3E, 0x46, 0x0D, 0xA6, 0x3D, 0x00, 0x00, 0xC0, 0x3F, 0xCD, 0xCC, 0x4C, 0x3D, 0x9A, 0x99, 0x19, 0x3E, 0xA6, 0x9B, 0x44, 0x3C, 0x00, 0x00, 0xC8, 0x41, 0xCD, 0xCC, 0xCC, 0x3D, 0x00, 0x00, 0x80, 0x3E, 0x00 });
